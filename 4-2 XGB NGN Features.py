...
top_features_indices = np.argsort(feature_importance)[-10:]  # Adjust the number of top features as needed
...
plt.title('Confusion Matrix by Percentage', size=14, weight='bold')
